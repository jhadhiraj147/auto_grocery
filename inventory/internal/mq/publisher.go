...
import (
	// This is the package generated by the flatc command
...
// ItemDetails helps pass both quantity and aisle to the publisher
...
// SendRobotCommand takes the Order ID and a map containing SKU, Quantity, and Aisle
func (p *Publisher) SendRobotCommand(orderID string, items map[string]ItemDetails) error {
	...
	for sku, detail := range items {
		// Create strings for SKU and Aisle
		...
		RobotMessages.ItemAddAisle(builder, a) // Successfully added Aisle here
